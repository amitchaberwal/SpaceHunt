package com.v4tech.spacehunt.pantompkins;

import static com.v4tech.spacehunt.AppParams.*;
import java.util.ArrayList;
import com.v4tech.spacehunt.pantompkins.PanTompkins.QRS.QrsArrhythmia;
import com.v4tech.spacehunt.pantompkins.PanTompkins.QRS.QrsClass;
import com.v4tech.spacehunt.pantompkins.PanTompkins.QRS.SegmentationStatus;
...
public class PanTompkins extends LmeFilter
{
    ...
    public int					samplingRate	= SAMPLING_RATE;

    /** sampling time in ms */
    public float				samplingTime	= 1000f/samplingRate;
    ...
    public static class QRS
    {
        ...
        public QrsArrhythmia		arrhythmia		= QrsArrhythmia.NORMAL_RHYTHM;
    ...
    private int                 heartRate           = NO_PEAK_HR;
     ...
     * @return
     */
    public int next (double xnow, long timestamp)
    {
        heartRate = NO_PEAK_HR;
        // cancel dc component
        ...
        if (startProcessing <= 0)
        {
            ...
            if (lastBeat > 3500)
            {
                ...
                //System.out.println("2"+QRS.qrsCurrent.segState);
                return heartRate;
            }
                    ...
                    else
                    {
                        ...
                        if (QRS.qrsCurrent.classify() != QrsClass.INVALID)
                        {
                            ...
                            if (QRS.qrsCurrent.feat_rr > 180 && QRS.qrsCurrent.feat_rr < 4000)
                            {
                                ...
                                heartRate = (int) heartRateStats
                                        .next(60000 / rrStats.value);
